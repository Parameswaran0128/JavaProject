...
//	    System.out.println(tableDataList);
	...
	protected static List<Map<String, Object>> ReadCompleteSalaryDetails(Connection connection,String EmpId){
    	List<Map<String, Object>> tableDataList = new ArrayList<>();
    	 String sqlQuery = "SELECT ns.NetSalaryID, ns.TotalEarning, ns.TotalDeduction, ns.netSalary, es.SalaryID, es.EmpId, es.BPAndDA, es.HRA, es.Conveyance, es.ProvidentFund, es.ESI, es.Loan, es.ProfessionTax, es.TDSOrIT, es.Month, es.Year " +
